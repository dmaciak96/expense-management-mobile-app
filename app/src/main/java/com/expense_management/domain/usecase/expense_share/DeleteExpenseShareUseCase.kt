...
class DeleteExpenseShareUseCase @Inject constructor(private val repository: ExpenseShareRepository) {
    // TODO: Add validation
    suspend operator fun invoke(expenseShare: ExpenseShare) =
        repository.delete(ExpenseShareMapper.toEntity(expenseShare))
}