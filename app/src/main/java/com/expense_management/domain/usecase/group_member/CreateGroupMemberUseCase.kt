...
class CreateGroupMemberUseCase @Inject constructor(private val repository: GroupMemberRepository) {
    // TODO: Add validation
    suspend operator fun invoke(groupMember: GroupMember) =
        repository.insert(GroupMemberMapper.toEntity(groupMember))
}