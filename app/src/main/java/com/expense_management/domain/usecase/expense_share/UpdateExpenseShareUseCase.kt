...
class UpdateExpenseShareUseCase @Inject constructor(private val repository: ExpenseShareRepository) {
    // TODO: Add validation
    suspend operator fun invoke(expenseShare: ExpenseShare) =
        repository.update(ExpenseShareMapper.toEntity(expenseShare))
}